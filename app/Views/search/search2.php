...
<?= $this->endSection() ?><?= $this->include('partials/header') ?>
            ...
            <div class="row">
                ...
                <div class="col-sm-8 mt-3">
                    ...
                    <div class="post ">
                                ...
                                <div class="card card-primary card-outline">
                                    <div class="card-body">
                                        <div class="row mt-o mb-0">
                                            <div class="col-sm-9">
                                                <h1 class="mt-o mb-0 ml-4 text-primary"><?= $i . '. ' ?>
                                                    <a href="<?php echo site_url('kalat?searctext=' . $meaning->word); ?>"><?php
                                                                                                                            echo  $meaning->word;
                                                                                                                            $i++; ?></a>
                                                </h1>
                                            </div>
                                            <div class="mt-o mb-0 col-sm-3">
                                                <ol class="float-right">
                                                    <i class="fa fa-clock-o mr-1"> <?php echo date('D/M/Y h:i:s', strtotime($meaning->created_at)); //->humanize()
                                                                                    ?></i>
                                                </ol>
                                            </div>
                                        </div>
                                        ...
                                        <form action="" method="post">
                                            <div class="row mt-0 mb-0">
                                                <div class="col-sm-6">
                                                    ...
                                                    <button class="button <?php if (isset($like) && $meaning->word_meaning_id == $id_) echo $like; ?>" value="<?= $meaning->num_like ?>,<?= $meaning->word_meaning_id ?>" name="like" formmethod="post">
                                                        <i class="fa fa-thumbs-up " style="font-size:26px">
                                                            <?php if ($meaning->num_like != 0) echo $meaning->num_like; ?>
                                                        </i>
                                                    </button>

                                                    <button class="button <?php if (isset($dislike) && $meaning->word_meaning_id == $id_) echo $dislike; ?>" value="<?= $meaning->num_dislike ?>,<?= $meaning->word_meaning_id ?>" name="dislike" formmethod="post">
                        ...
                        <footer class="main-footer position:fixed"><!-- position: fixed; -->
